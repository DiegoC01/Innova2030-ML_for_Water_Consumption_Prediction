...
loaded_model = tf.keras.saving.load_model("gru_model/gru_training/15_days_horizon/models/gru_daily_15_days_horizon.h5")
...
get_performance(predicted_values=prediction, real_values=y_test, model_name="GRU: 15-Days Horizon with daily data")