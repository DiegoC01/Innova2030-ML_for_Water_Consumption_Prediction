...
loaded_model = tf.keras.saving.load_model("gru_model/gru_training/1_week_horizon/models/gru_daily_1_week_horizon.h5")
...
get_performance(predicted_values=prediction, real_values=y_test, model_name="GRU: 1-Week Horizon with daily data")